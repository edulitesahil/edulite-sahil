...
public class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("You will play first. Enter a slot number to place X in:");
        ...
        // If no one wins or loses, then here is the logic to print "draw".
